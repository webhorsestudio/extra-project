...
interface MobileTermsClientProps {
  policy: {
    name?: string
    description?: string
    content?: string
        ...
        <div className="min-h-screen bg-gray-50">
          ...
          <div className="bg-white/90 backdrop-blur-md border-b border-gray-200/50 px-4 py-3">
            <div className="flex items-center justify-between">
              ...
              <h1 className="text-lg font-semibold text-gray-900">Terms of Use</h1>
          ...
          <div className="flex items-center justify-center min-h-[calc(100vh-80px)] px-4">
            <div className="text-center max-w-sm">
              ...
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Terms and Conditions</h2>
    ...
    <HydrationSuppressor>
      <div className="min-h-screen bg-gray-50">
        ...
        <style jsx>{`
          ...
          .mobile-terms-content ul {
            margin-bottom: 0.75rem;
            padding-left: 1.25rem;
          }

          .mobile-terms-content li {
            margin-bottom: 0.25rem;
            color: #4b5563;
          }

          .mobile-terms-content strong {
            color: #1f2937;
            font-weight: 600;
          }
          ...
          .mobile-terms-content blockquote {
