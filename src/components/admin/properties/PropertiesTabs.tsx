  ...
  return (
    <Tabs defaultValue="filters" className="w-full">
      <TabsList className="grid w-full grid-cols-2">
        ...
        <TabsTrigger value="sort-select" className="flex items-center gap-2">
      ...
      <TabsContent value="sort-select" className="space-y-4">
        {/* Sorting */}
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={selectedProperties.length === filteredProperties.length ? clearSelection : selectAllProperties}
                    className="rounded border-gray-300"
                  />
                  <span className="text-sm font-medium">
                    {selectedProperties.length === filteredProperties.length && filteredProperties.length > 0 ? 'Deselect All' : 'Select All'}
                  </span>
                </div>
                {selectedProperties.length > 0 && (
